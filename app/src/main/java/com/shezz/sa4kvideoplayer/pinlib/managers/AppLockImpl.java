...
import com.shezz.sa4kvideoplayer.pinlib.encryption.Encryptor;
import com.shezz.sa4kvideoplayer.pinlib.enums.Algorithm;
import com.shezz.sa4kvideoplayer.pinlib.interfaces.LifeCycleInterface;
...
public class AppLockImpl<T extends AppLockActivity> extends AppLock implements LifeCycleInterface {
    ...
    public boolean shouldShowForgot(int appLockType) {
        return mSharedPreferences.getBoolean(SHOW_FORGOT_PREFERENCE_KEY, true)
                && appLockType != ENABLE_PINLOCK && appLockType != CONFIRM_PIN;
    }
