...
public class SettingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(SettingActivity.this,R.color.dark_gray4));
        theme();
     ...
     //   sharedPreferences.edit().putString("THEMENAME", (String)v.getTag()).apply();
        ...
        if(sharedPreferences.getInt("THEME", 0)!=111) {
            ...
            getWindow().setStatusBarColor(ContextCompat.getColor(SettingActivity.this,R.color.toolbar_style));
