package com.mxplayer.paksoft.adapter;
...
import com.mxplayer.paksoft.LineProgress.LineProgress;
...
public class VideoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") int i) {
        ...
        if (viewType == UNIFIED_NATIVE_AD_VIEW_TYPE) {
            ...
            Glide.with(mContext)
                    .load(Uri.fromFile(new File(video.getPath()))).placeholder(R.drawable.ic_drawable_back)
                    .into(holder1.thumb);
            ...
            if (option.equalsIgnoreCase("")) {
                ...
                if (selected_usersList.contains(videoList2.get(i))) {
                    holder1.select.setVisibility(View.VISIBLE);
                    holder1.select1.setVisibility(View.VISIBLE);
                    holder1.selectedvideo.setVisibility(View.VISIBLE);
                    holder1.maincolor.setBackgroundColor(ContextCompat.getColor(mContext, R.color.list_item_selected_state));
                }else{
                holder1.select.setVisibility(View.GONE);
                holder1.select1.setVisibility(View.GONE);
                holder1.selectedvideo.setVisibility(View.GONE);
                holder1.optiontag.setVisibility(View.VISIBLE);
                holder1.maincolor.setBackgroundColor(color);}
                holder1.clickevent.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        if (mContext instanceof MainActivity) {
                            ((MainActivity)mContext).stopMusicPlayer();
                        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        RoundedImageView selectedvideo;
        RoundedImageView thumb;
        ImageView foldertag,select,select1;
        TextView title, duration,videotime,startend;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            if(option.equalsIgnoreCase("")) {
                ...
                selectedvideo = itemView.findViewById(R.id.video_thumb_selected);
                select = itemView.findViewById(R.id.ic_select);
                select1 = itemView.findViewById(R.id.ic_select1);
