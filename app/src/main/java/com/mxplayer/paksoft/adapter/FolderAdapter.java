...
public class FolderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") int i) {
        ...
        if (viewType == UNIFIED_NATIVE_AD_VIEW_TYPE) {
            ...
            holder1.tvTotalVideosCount.setText(folder.getTotal_video() + " video");
            ...
            if (selected_usersList.contains(folderModelList.get(i))) {
                ...
                holder1.folder.setBackground(ContextCompat.getDrawable(mContext, R.drawable.ic_folder_selected_dark));
            }else{
                ...
                holder1.folder.setBackground(ContextCompat.getDrawable(mContext, R.drawable.folder));
            }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        ImageView option,folder,select,select1;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            folder = itemView.findViewById(R.id.video_thumb);
