package com.mxplayer.paksoft.player;
...
public class Mediaplayer extends AppCompatActivity implements View.OnClickListener, PlaybackPreparer, PlayerControlView.VisibilityListener {
    ...
    RelativeLayout control_click,resume_lay,nigthmode,loop_back,night_layout,speed_layout;
    private TextView debugTextView,tv_title,start_over,btnSpeed1x,btnSpeed2x,btnSpeed3x,btnSpeed4x;
...
boolean autonext=false;
    ...
    public void onCreate(Bundle savedInstanceState) {
        try {
            ...
            this.speed_layout = (RelativeLayout) findViewById(R.id.speed_layout);
            ...
            this.btnSpeed1x = (TextView) findViewById(R.id.btnSpeed1x);
            btnSpeed1x.setOnClickListener(this);
            this.btnSpeed2x = (TextView) findViewById(R.id.btnSpeed2x);
            btnSpeed2x.setOnClickListener(this);
            this.btnSpeed3x = (TextView) findViewById(R.id.btnSpeed3x);
            btnSpeed3x.setOnClickListener(this);
            this.btnSpeed4x = (TextView) findViewById(R.id.btnSpeed4x);
            btnSpeed4x.setOnClickListener(this);
    ...
    public void onClick(View view) {
        try {
            ...
            if (view.getId() == R.id.btnSpeed1x) {
                ...
                btnSpeed1x.setVisibility(View.GONE);
                btnSpeed2x.setVisibility(View.VISIBLE);
                btnSpeed3x.setVisibility(View.GONE);
                btnSpeed4x.setVisibility(View.GONE);
            }
            ...
            if (view.getId() == R.id.btnSpeed2x) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    param.setSpeed(3f);// 1f is 1x, 2f is 2x
                }
                player.setPlaybackParams(param);
                btnSpeed1x.setVisibility(View.GONE);
                btnSpeed2x.setVisibility(View.GONE);
                btnSpeed3x.setVisibility(View.VISIBLE);
                btnSpeed4x.setVisibility(View.GONE);
            }
            ...
            if (view.getId() == R.id.btnSpeed3x) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    param.setSpeed(4f);// 1f is 1x, 2f is 2x
                }
                player.setPlaybackParams(param);
                btnSpeed1x.setVisibility(View.GONE);
                btnSpeed2x.setVisibility(View.GONE);
                btnSpeed3x.setVisibility(View.GONE);
                btnSpeed4x.setVisibility(View.VISIBLE);
            }
            ...
            if (view.getId() == R.id.btnSpeed4x) {
                ...
                player.setPlaybackParams(param);
                btnSpeed1x.setVisibility(View.VISIBLE);
                btnSpeed2x.setVisibility(View.GONE);
                btnSpeed3x.setVisibility(View.GONE);
                btnSpeed4x.setVisibility(View.GONE);
            }
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (id == R.id.subtitle) {
                    if(session_media.getBoolean("is_subtitle_show",false)) {
                        File mPath = new File(Environment.getExternalStorageDirectory() + "//DIR//");
                        Filedialog fileDialog = new Filedialog(Mediaplayer.this, mPath, ".vtt");
                        fileDialog.addFileListener(new Filedialog.FileSelectedListener() {
                            public void fileSelected(File file) {
...
//                    }
    ...
    public void openEqualizer() {
        ...
        if ((eqIntent.resolveActivity(getPackageManager()) != null)) {
            ...
            Toast.makeText(Mediaplayer.this, "No Equalizer found!",
