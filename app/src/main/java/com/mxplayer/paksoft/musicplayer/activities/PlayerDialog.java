package com.mxplayer.paksoft.musicplayer.activities;
...
import com.mxplayer.paksoft.musicplayer.player.PlayerListener;
import com.mxplayer.paksoft.musicplayer.player.PlayerManager;
import com.mxplayer.paksoft.musicplayer.player.PlayerQueue;
...
public class PlayerDialog extends BottomSheetDialog implements SeekBar.OnSeekBarChangeListener, PlayerListener, View.OnClickListener {
    ...
    private final ImageView albumArt,albumArt1;
    ...
    public PlayerDialog(@NonNull Context context, PlayerManager playerManager) {
        ...
        BlurImageView blurImageView = (BlurImageView) findViewById(R.id.blurImage);
        blurImageView.setBlur(20);
        animation = AnimationUtils.loadAnimation(context, R.anim.rotation);
        albumArt1 = (ImageView)findViewById(R.id.album_art1);
        if (playerManager != null && playerManager.isPlaying())
            albumArt1.startAnimation(animation);
        else
            albumArt1.clearAnimation();
