...
import com.mxplayer.paksoft.App;
import com.mxplayer.paksoft.R;
import com.mxplayer.paksoft.activity.MainActivity;
import com.mxplayer.paksoft.adapter.VideoAdapter;
import com.mxplayer.paksoft.db.DbHandler;
import com.mxplayer.paksoft.models.VideoModel;
import com.mxplayer.paksoft.utils.CustomVerticalSeekbar;
import com.mxplayer.paksoft.utils.Filedialog;
import com.mxplayer.paksoft.utils.MyUtils;
import com.mxplayer.paksoft.utils.ZoomableExoPlayerView;
...
public class OnlineStreamActivity extends AppCompatActivity implements View.OnClickListener, PlaybackPreparer, PlayerControlView.VisibilityListener {
    ...
    private Handler handler = new Handler(Looper.getMainLooper()) {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 3:
                    try {
                        if (com.mxplayer.paksoft.OnlineStreamActivity.this.newPosition >= 0) {
                            com.mxplayer.paksoft.OnlineStreamActivity.this.playerView.getPlayer().seekTo((long) ((int) com.mxplayer.paksoft.OnlineStreamActivity.this.newPosition));
                            com.mxplayer.paksoft.OnlineStreamActivity.this.newPosition = -1;
                            return;
                        }
                        return;
                    } catch (Exception e) {
                ...
                case 4:
                    try {
                        com.mxplayer.paksoft.OnlineStreamActivity.this.query.id(R.id.app_video_volume_box).gone();
                        com.mxplayer.paksoft.OnlineStreamActivity.this.query.id(R.id.app_video_brightness_box).gone();
                        com.mxplayer.paksoft.OnlineStreamActivity.this.query.id(R.id.app_video_fastForward_box).gone();
                        com.mxplayer.paksoft.OnlineStreamActivity.this.query.id(R.id.app_video_ratio_box).gone();
    ...
    private com.mxplayer.paksoft.OnlineStreamActivity.Query query;
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            if (!MyUtils.is_zoom) {
                ...
                if (this.firstTouch) {
                    ...
                    if (mOldX <= ((float) com.mxplayer.paksoft.OnlineStreamActivity.this.screenWidthPixels) * 0.5f) {
                        z = false;
                    }
                ...
                if (this.toSeek) {
                    com.mxplayer.paksoft.OnlineStreamActivity playerActivity = com.mxplayer.paksoft.OnlineStreamActivity.this;
                    playerActivity.onProgressSlide((-deltaX) / ((float) playerActivity.playerView.getWidth()));
                } else {
                    float percent = deltaY / ((float) com.mxplayer.paksoft.OnlineStreamActivity.this.playerView.getHeight());

                    Log.d("volumeslide", com.mxplayer.paksoft.OnlineStreamActivity.this.playerView.getHeight() + "");
                    if (this.volumeControl) {
                        com.mxplayer.paksoft.OnlineStreamActivity.this.onVolumeSlide(percent);
                    } else {
                        float percent2 = deltaY / 4500;
                        com.mxplayer.paksoft.OnlineStreamActivity.this.onBrightnessSlide(percent2);
                    }
                }
            }
            endGesture();
    ...
    class Query {
        ...
        public com.mxplayer.paksoft.OnlineStreamActivity.Query id(int id) {
            this.view = com.mxplayer.paksoft.OnlineStreamActivity.this.findViewById(id);
            return this;
        }

        public com.mxplayer.paksoft.OnlineStreamActivity.Query image(int resId) {
            View view = this.view;
        ...
        public com.mxplayer.paksoft.OnlineStreamActivity.Query visible() {
            View view = this.view;
            if (view != null) {
        ...
        @SuppressLint({"WrongConstant"})
        public com.mxplayer.paksoft.OnlineStreamActivity.Query gone() {
            View view = this.view;
            if (view != null) {
        ...
        @SuppressLint({"WrongConstant"})
        public com.mxplayer.paksoft.OnlineStreamActivity.Query invisible() {
            View view = this.view;
            if (view != null) {
        ...
        public com.mxplayer.paksoft.OnlineStreamActivity.Query text(CharSequence text) {
            View view = this.view;
        ...
        public com.mxplayer.paksoft.OnlineStreamActivity.Query visibility(int visible) {
            View view = this.view;
            if (view != null) {
    ...
    private class PlayerErrorMessageProvider implements ErrorMessageProvider<ExoPlaybackException> {
        ...
        public Pair<Integer, String> getErrorMessage(ExoPlaybackException e) {
            String errorString = com.mxplayer.paksoft.OnlineStreamActivity.this.getString(R.string.error_generic);
            if (e.type == 1) {
                Exception cause = e.getRendererException();
                if (cause instanceof MediaCodecRenderer.DecoderInitializationException) {
                    MediaCodecRenderer.DecoderInitializationException decoderInitializationException = (MediaCodecRenderer.DecoderInitializationException) cause;
                    if (decoderInitializationException.decoderName != null) {
                        errorString = com.mxplayer.paksoft.OnlineStreamActivity.this.getString(R.string.error_instantiating_decoder, new Object[]{decoderInitializationException.decoderName});
                    } else if (decoderInitializationException.getCause() instanceof MediaCodecUtil.DecoderQueryException) {
                        errorString = com.mxplayer.paksoft.OnlineStreamActivity.this.getString(R.string.error_querying_decoders);
                    } else if (decoderInitializationException.secureDecoderRequired) {
                        errorString = com.mxplayer.paksoft.OnlineStreamActivity.this.getString(R.string.error_no_secure_decoder, new Object[]{decoderInitializationException.mimeType});
                    } else {
                        errorString = com.mxplayer.paksoft.OnlineStreamActivity.this.getString(R.string.error_no_decoder, new Object[]{decoderInitializationException.mimeType});
                    }
                }
            }
    ...
    private class PlayerEventListener implements Player.EventListener {
        ...
        public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
            ...
            if (playbackState == 4) {
                ...
                try {
                    com.mxplayer.paksoft.OnlineStreamActivity.this.showControls();
                } catch (Exception e) {
                    e.printStackTrace();
                    return;
                }
            ...
            com.mxplayer.paksoft.OnlineStreamActivity.this.updateButtonVisibilities();
        }


        public void onPositionDiscontinuity(int reason) {
            String media_id = VideoAdapter.videoList.get(com.mxplayer.paksoft.OnlineStreamActivity.this.player.getCurrentWindowIndex()).getMedia_id();
            String name = VideoAdapter.videoList.get(com.mxplayer.paksoft.OnlineStreamActivity.this.player.getCurrentWindowIndex()).getName();
            Log.i("playername", name);
            try {
                if (com.mxplayer.paksoft.OnlineStreamActivity.this.player.getPlaybackError() != null) {

                    com.mxplayer.paksoft.OnlineStreamActivity.this.updateStartPosition();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        public void onPlayerError(ExoPlaybackException e) {
            try {
                if (com.mxplayer.paksoft.OnlineStreamActivity.isBehindLiveWindow(e)) {
                    com.mxplayer.paksoft.OnlineStreamActivity.this.clearStartPosition();
                    com.mxplayer.paksoft.OnlineStreamActivity.this.initializePlayer();
                    return;
                }
                com.mxplayer.paksoft.OnlineStreamActivity.this.updateStartPosition();
                com.mxplayer.paksoft.OnlineStreamActivity.this.updateButtonVisibilities();
        ...
        public void onTracksChanged(TrackGroupArray trackGroups, TrackSelectionArray trackSelections) {
            try {
                com.mxplayer.paksoft.OnlineStreamActivity.this.updateButtonVisibilities();
                if (trackGroups != com.mxplayer.paksoft.OnlineStreamActivity.this.lastSeenTrackGroupArray) {
                    MappingTrackSelector.MappedTrackInfo mappedTrackInfo = com.mxplayer.paksoft.OnlineStreamActivity.this.trackSelector.getCurrentMappedTrackInfo();
                    if (mappedTrackInfo != null) {
                        if (mappedTrackInfo.getTypeSupport(2) == MappingTrackSelector.MappedTrackInfo.RENDERER_SUPPORT_UNSUPPORTED_TRACKS) {
                            com.mxplayer.paksoft.OnlineStreamActivity.this.showToast((int) R.string.error_unsupported_video);
                        }
                        if (mappedTrackInfo.getTypeSupport(1) == MappingTrackSelector.MappedTrackInfo.RENDERER_SUPPORT_UNSUPPORTED_TRACKS) {
                            com.mxplayer.paksoft.OnlineStreamActivity.this.showToast((int) R.string.error_unsupported_audio);
                        }
                    }
                    com.mxplayer.paksoft.OnlineStreamActivity.this.lastSeenTrackGroupArray = trackGroups;


                    String media_id = VideoAdapter.videoList.get(com.mxplayer.paksoft.OnlineStreamActivity.this.player.getCurrentWindowIndex()).getMedia_id();
                    tv_title.setText(VideoAdapter.videoList.get(com.mxplayer.paksoft.OnlineStreamActivity.this.player.getCurrentWindowIndex()).getName());
                    ...
                    if (session_media.getBoolean("is_autoplay", false)) {
                        ...
                        if (session_media.getBoolean("is_resume", false)) {
                            if (db.CheckIsVideoView("track_id", media_id)) {
                                ...
                                showResumeDialog(com.mxplayer.paksoft.OnlineStreamActivity.this.player.getCurrentWindowIndex());
...
//            }
            ...
            this.playerView.setErrorMessageProvider(new com.mxplayer.paksoft.OnlineStreamActivity.PlayerErrorMessageProvider());
            ...
            try {
                this.query = new com.mxplayer.paksoft.OnlineStreamActivity.Query(this);
            ...
            try {
                ...
                gestureDetector = new GestureDetector(this, new com.mxplayer.paksoft.OnlineStreamActivity.PlayerGestureListener());
                ...
                this.playerView.setOnTouchListener(new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View view, MotionEvent motionEvent) {
                        ...
                        if ((motionEvent.getAction() & 255) == 1) {
                            try {
                                com.mxplayer.paksoft.OnlineStreamActivity.this.endGesture();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
    ...
    private void onBrightnessSlide(float percent) {
        try {
            ...
            com.mxplayer.paksoft.OnlineStreamActivity.Query id = this.query.id(R.id.app_video_brightness);
    ...
    private void onProgressSlide(float percent) {
        try {
            ...
            if (showDelta != 0) {
                ...
                com.mxplayer.paksoft.OnlineStreamActivity.Query id = this.query.id(R.id.app_video_fastForward);
...
//                onBackPressed();
                ...
                startActivity(new Intent(com.mxplayer.paksoft.OnlineStreamActivity.this, MainActivity.class));
                finish();
            }
            ...
            if (view.getId() == R.id.btnSubtitle) {
                ...
                if (session_media.getBoolean("is_subtitle_show", false)) {
                    ...
                    Filedialog fileDialog = new Filedialog(com.mxplayer.paksoft.OnlineStreamActivity.this, mPath, ".vtt");
        ...
        try {
            ...
            player.prepare(mediaSource, true, false);
                ...
                if (!Util.checkCleartextTrafficPermitted(uris)) {
                    ...
                    this.player.addListener(new com.mxplayer.paksoft.OnlineStreamActivity.PlayerEventListener());
                        ...
                        if (mappedTrackInfo.getTrackGroups(i).length != 0) {
                            ...
                            try {
                                ...
                                if (session_media.getBoolean("is_subtitle_show", false)) {
                                    ...
                                    com.mxplayer.paksoft.OnlineStreamActivity.this.query.id(R.id.exo_subtitles).gone();
                                }
                            } catch (Exception e22) {
                                e22.printStackTrace();
                            }
...
//                    }
    ...
    private void ShowInterstitalAds() {
        if (this.mInterstitialAdMob != null) {
            this.mInterstitialAdMob.show(com.mxplayer.paksoft.OnlineStreamActivity.this);
    ...
    public void openEqualizer() {
        ...
        if ((eqIntent.resolveActivity(getPackageManager()) != null)) {
            ...
            Toast.makeText(com.mxplayer.paksoft.OnlineStreamActivity.this, "No Equalizer found!",
